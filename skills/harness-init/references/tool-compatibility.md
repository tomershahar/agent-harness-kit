# Tool Compatibility — harness-init

## Claude Code

**Trigger:** Type `harness-init` in the chat window.
...
- Copilot Chat can run terminal commands when given explicit paths — use `bash /path/to/harness-init.sh`
